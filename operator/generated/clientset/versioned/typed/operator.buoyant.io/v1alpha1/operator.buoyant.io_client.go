...
import (
	...
	"github.com/buoyantio/linkerd-buoyant/operator/generated/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type OperatorV1alpha1Interface interface {
	RESTClient() rest.Interface
	ControlPlaneUpdatesGetter
	DataPlaneUpdatesGetter
}

// OperatorV1alpha1Client is used to interact with features provided by the operator.buoyant.io group.
type OperatorV1alpha1Client struct {
	restClient rest.Interface
}

func (c *OperatorV1alpha1Client) ControlPlaneUpdates() ControlPlaneUpdateInterface {
	return newControlPlaneUpdates(c)
}

func (c *OperatorV1alpha1Client) DataPlaneUpdates(namespace string) DataPlaneUpdateInterface {
	return newDataPlaneUpdates(c, namespace)
}
